...
//***************************************************************************
// Returns true if the collection contains a piont that matches the argument
//***************************************************************************
...
//***************************************************************************
// sets the state of the receiving instance so that it matches the agument
//***************************************************************************

const PointCollection& PointCollection::operator=(const PointCollection &c)
{
    // deallocate the existing
    delete [] data;
